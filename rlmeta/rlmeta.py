...
class Parser:
    def __init__(self):
        ...
        self._rules = {
            ...
            'body': self._matcher_54,
            'field': self._matcher_60,
            'rule': self._matcher_71,
            'choice': self._matcher_93,
            'sequence': self._matcher_105,
            'expr': self._matcher_127,
            'expr1': self._matcher_152,
            'expr2': self._matcher_161,
            'expr3': self._matcher_232,
            'matchChar': self._matcher_237,
            'maybeAction': self._matcher_245,
            'actionExpr': self._matcher_275,
            'hostExpr': self._matcher_324,
            'hostListItem': self._matcher_333,
            'var': self._matcher_343,
            'restLine': self._matcher_356,
            'indented': self._matcher_362,
            'string': self._matcher_376,
            'char': self._matcher_386,
            'innerChar': self._matcher_393,
            'escape': self._matcher_410,
            'number': self._matcher_418,
            'name': self._matcher_428,
            'reserved': self._matcher_433,
            'keyDef': self._matcher_440,
            'keyActor': self._matcher_449,
            'nameStart': self._matcher_454,
            'nameChar': self._matcher_461,
            'space': self._matcher_468,
        }
    def run(self, stream):
        return self._rules['run'](stream)
    def _matcher_0(self, stream):
    ...
    def _matcher_36(self, stream):
        return stream.operator_star(self._matcher_35)
    def _matcher_37(self, stream):
        return stream.bind('zs', self._matcher_36(stream))
    def _matcher_38(self, stream):
    ...
    def _matcher_49(self, stream):
        return stream.operator_star(self._matcher_48)
    def _matcher_50(self, stream):
        return stream.bind('zs', self._matcher_49(stream))
    ...
    def _matcher_57(self, stream):
        return stream.bind('x', self._matcher_56(stream))
    ...
    def _matcher_60(self, stream):
        return stream.with_scope(self._matcher_59)
    def _matcher_61(self, stream):
        return self._rules['name'](stream)
    def _matcher_62(self, stream):
        return stream.bind('x', self._matcher_61(stream))
    ...
    def _matcher_68(self, stream):
        return stream.bind('y', self._matcher_67(stream))
    ...
    def _matcher_89(self, stream):
        return stream.operator_star(self._matcher_88)
    def _matcher_90(self, stream):
        return stream.bind('xs', self._matcher_89(stream))
    ...
    def _matcher_102(self, stream):
        return stream.bind('ys', self._matcher_101(stream))
    ...
    def _matcher_107(self, stream):
        return stream.bind('x', self._matcher_106(stream))
    ...
    def _matcher_118(self, stream):
        return stream.operator_star(self._matcher_117)
    def _matcher_119(self, stream):
        return stream.bind('xs', self._matcher_118(stream))
    ...
    def _matcher_126(self, stream):
        return stream.with_scope(self._matcher_125)
    ...
    def _matcher_151(self, stream):
        return stream.with_scope(self._matcher_150)
    ...
    def _matcher_158(self, stream):
        return stream.with_scope(self._matcher_157)
    ...
    def _matcher_191(self, stream):
        return stream.operator_not(self._matcher_190)
    ...
    def _matcher_231(self, stream):
        return stream.with_scope(self._matcher_230)
    ...
    def _matcher_234(self, stream):
        return stream.bind('x', self._matcher_233(stream))
    ...
    def _matcher_242(self, stream):
        return stream.with_scope(self._matcher_241)
    def _matcher_243(self, stream):
        return stream.action(lambda self: self.lookup('concat')([
        
        ]))
    def _matcher_244(self, stream):
        return stream.with_scope(self._matcher_243)
    ...
    def _matcher_259(self, stream):
        return stream.with_scope(self._matcher_258)
    ...
    def _matcher_261(self, stream):
        return stream.bind('y', self._matcher_260(stream))
    ...
    def _matcher_265(self, stream):
        return stream.bind('z', self._matcher_264(stream))
    ...
    def _matcher_277(self, stream):
        return stream.bind('x', self._matcher_276(stream))
    ...
    def _matcher_280(self, stream):
        return stream.with_scope(self._matcher_279)
    def _matcher_281(self, stream):
        return self._rules['number'](stream)
    def _matcher_282(self, stream):
        return stream.bind('x', self._matcher_281(stream))
    ...
    def _matcher_285(self, stream):
        return stream.with_scope(self._matcher_284)
    ...
    def _matcher_290(self, stream):
        return stream.operator_star(self._matcher_289)
    def _matcher_291(self, stream):
        return stream.bind('xs', self._matcher_290(stream))
    ...
    def _matcher_296(self, stream):
        return stream.with_scope(self._matcher_295)
    ...
    def _matcher_301(self, stream):
        return stream.operator_star(self._matcher_300)
    def _matcher_302(self, stream):
        return stream.bind('xs', self._matcher_301(stream))
    ...
    def _matcher_309(self, stream):
        return stream.bind('x', self._matcher_308(stream))
    ...
    def _matcher_323(self, stream):
        return stream.with_scope(self._matcher_322)
    ...
    def _matcher_327(self, stream):
        return stream.operator_star(self._matcher_326)
    def _matcher_328(self, stream):
        return stream.bind('ys', self._matcher_327(stream))
    def _matcher_329(self, stream):
        return self._rules['hostExpr'](stream)
    def _matcher_330(self, stream):
        return stream.bind('x', self._matcher_329(stream))
    ...
    def _matcher_335(self, stream):
        return stream.bind('x', self._matcher_334(stream))
    ...
    def _matcher_340(self, stream):
        return stream.operator_not(self._matcher_339)
    ...
    def _matcher_351(self, stream):
        return stream.operator_star(self._matcher_350)
    def _matcher_352(self, stream):
        return stream.bind('xs', self._matcher_351(stream))
    ...
    def _matcher_356(self, stream):
        return stream.with_scope(self._matcher_355)
    def _matcher_357(self, stream):
        return stream.match(lambda item: item == ' ', "' '")
    def _matcher_358(self, stream):
        return self._rules['restLine'](stream)
    def _matcher_359(self, stream):
        return stream.bind('x', self._matcher_358(stream))
    ...
    def _matcher_366(self, stream):
        return stream.operator_not(self._matcher_365)
    ...
    def _matcher_369(self, stream):
        return stream.with_scope(self._matcher_368)
    ...
    def _matcher_382(self, stream):
        return stream.bind('x', self._matcher_381(stream))
    ...
    def _matcher_405(self, stream):
        return stream.with_scope(self._matcher_404)
    ...
    def _matcher_418(self, stream):
        return stream.with_scope(self._matcher_417)
    ...
    def _matcher_428(self, stream):
        return stream.with_scope(self._matcher_427)
    ...
    def _matcher_438(self, stream):
        return stream.operator_not(self._matcher_437)
    ...
    def _matcher_447(self, stream):
        return stream.operator_not(self._matcher_446)
    ...
    def _matcher_458(self, stream):
        return stream.with_scope(self._matcher_457)
    ...
    def _matcher_467(self, stream):
        return stream.operator_star(self._matcher_466)
    def _matcher_468(self, stream):
        return stream.with_scope(self._matcher_467)
class Optimizer:
    def __init__(self):
        self._state = {}
        self._rules = {
