...
class Cli:
    ...
    def _matcher_5(self, stream):
        return stream.with_scope(self._state, self._matcher_4)
    ...
    def _matcher_14(self, stream):
        return stream.with_scope(self._state, self._matcher_13)
    ...
    def _matcher_21(self, stream):
        return stream.with_scope(self._state, self._matcher_20)
    ...
    def _matcher_29(self, stream):
        return stream.with_scope(self._state, self._matcher_28)
    ...
    def _matcher_39(self, stream):
        return stream.with_scope(self._state, self._matcher_38)
    ...
    def _matcher_47(self, stream):
        return stream.with_scope(self._state, self._matcher_46)
    ...
    def _matcher_51(self, stream):
        return stream.with_scope(self._state, self._matcher_50)
...
class SequenceWriter:
    ...
    def _matcher_2(self, stream):
        return stream.match(lambda item: True, 'any')
    def _matcher_3(self, stream):
        return stream.bind('x', self._matcher_2(stream))
    def _matcher_4(self, stream):
        return stream.match(lambda item: True, 'any')
    def _matcher_5(self, stream):
    ...
    def _matcher_8(self, stream):
        return stream.with_scope(self._state, self._matcher_7)
    def _matcher_9(self, stream):
        return stream.operator_or([
            self._matcher_8
        ])
class Parser:
    def __init__(self, n=None):
        ...
        self._rules = {
            ...
            'hostExpr': self._matcher_326,
            'hostListItem': self._matcher_337,
            'var': self._matcher_350,
            'string': self._matcher_367,
            'char': self._matcher_380,
            'innerChar': self._matcher_389,
            'escape': self._matcher_410,
            'number': self._matcher_419,
            'name': self._matcher_429,
            'nameStart': self._matcher_436,
            'nameChar': self._matcher_446,
            'space': self._matcher_459,
        }
    def run(self, stream):
        return self._rules['run'](stream)
    def _matcher_0(self, stream):
    ...
    def _matcher_9(self, stream):
        return stream.with_scope(self._state, self._matcher_8)
    def _matcher_10(self, stream):
        return stream.operator_or([
            self._matcher_9
        ])
    ...
    def _matcher_23(self, stream):
        return stream.with_scope(self._state, self._matcher_22)
    def _matcher_24(self, stream):
        return stream.operator_or([
            self._matcher_23
        ])
    ...
    def _matcher_38(self, stream):
        return stream.with_scope(self._state, self._matcher_37)
    def _matcher_39(self, stream):
        return stream.operator_or([
            self._matcher_38
        ])
    ...
    def _matcher_49(self, stream):
        return stream.with_scope(self._state, self._matcher_48)
    def _matcher_50(self, stream):
        return stream.operator_or([
            self._matcher_49
        ])
    ...
    def _matcher_55(self, stream):
        return stream.with_scope(self._state, self._matcher_54)
    ...
    def _matcher_66(self, stream):
        return stream.with_scope(self._state, self._matcher_65)
    ...
    def _matcher_72(self, stream):
        return stream.with_scope(self._state, self._matcher_71)
    ...
    def _matcher_81(self, stream):
        return stream.with_scope(self._state, self._matcher_80)
    ...
    def _matcher_92(self, stream):
        return stream.with_scope(self._state, self._matcher_91)
    ...
    def _matcher_104(self, stream):
        return stream.with_scope(self._state, self._matcher_103)
    ...
    def _matcher_107(self, stream):
        return stream.with_scope(self._state, self._matcher_106)
    ...
    def _matcher_116(self, stream):
        return stream.with_scope(self._state, self._matcher_115)
    ...
    def _matcher_124(self, stream):
        return stream.with_scope(self._state, self._matcher_123)
    ...
    def _matcher_132(self, stream):
        return stream.with_scope(self._state, self._matcher_131)
    ...
    def _matcher_138(self, stream):
        return stream.with_scope(self._state, self._matcher_137)
    ...
    def _matcher_146(self, stream):
        return stream.with_scope(self._state, self._matcher_145)
    ...
    def _matcher_149(self, stream):
        return stream.with_scope(self._state, self._matcher_148)
    ...
    def _matcher_157(self, stream):
        return stream.with_scope(self._state, self._matcher_156)
    ...
    def _matcher_162(self, stream):
        return stream.with_scope(self._state, self._matcher_161)
    ...
    def _matcher_172(self, stream):
        return stream.with_scope(self._state, self._matcher_171)
    ...
    def _matcher_181(self, stream):
        return stream.with_scope(self._state, self._matcher_180)
    ...
    def _matcher_189(self, stream):
        return stream.with_scope(self._state, self._matcher_188)
    ...
    def _matcher_195(self, stream):
        return stream.with_scope(self._state, self._matcher_194)
    ...
    def _matcher_206(self, stream):
        return stream.with_scope(self._state, self._matcher_205)
    ...
    def _matcher_212(self, stream):
        return stream.with_scope(self._state, self._matcher_211)
    ...
    def _matcher_218(self, stream):
        return stream.with_scope(self._state, self._matcher_217)
    ...
    def _matcher_224(self, stream):
        return stream.with_scope(self._state, self._matcher_223)
    ...
    def _matcher_230(self, stream):
        return stream.with_scope(self._state, self._matcher_229)
    ...
    def _matcher_233(self, stream):
        return stream.with_scope(self._state, self._matcher_232)
    ...
    def _matcher_246(self, stream):
        return stream.with_scope(self._state, self._matcher_245)
    ...
    def _matcher_249(self, stream):
        return stream.with_scope(self._state, self._matcher_248)
    ...
    def _matcher_256(self, stream):
        return stream.with_scope(self._state, self._matcher_255)
    ...
    def _matcher_263(self, stream):
        return stream.with_scope(self._state, self._matcher_262)
    ...
    def _matcher_270(self, stream):
        return stream.with_scope(self._state, self._matcher_269)
    ...
    def _matcher_276(self, stream):
        return stream.with_scope(self._state, self._matcher_275)
    ...
    def _matcher_288(self, stream):
        return stream.with_scope(self._state, self._matcher_287)
    ...
    def _matcher_300(self, stream):
        return stream.with_scope(self._state, self._matcher_299)
    ...
    def _matcher_305(self, stream):
        return stream.bind('x', self._matcher_304(stream))
    def _matcher_306(self, stream):
        return stream.action(lambda self: self.lookup('concat')([
            self.lookup('splice')(0, 'State2'),
            self.lookup('splice')(0, self.lookup('x'))
        ]))
    ...
    def _matcher_308(self, stream):
        return stream.with_scope(self._state, self._matcher_307)
    def _matcher_309(self, stream):
        return self._rules['var'](stream)
    def _matcher_310(self, stream):
        return stream.bind('x', self._matcher_309(stream))
    ...
    def _matcher_316(self, stream):
        return stream.bind('ys', self._matcher_315(stream))
    ...
    def _matcher_322(self, stream):
        return stream.with_scope(self._state, self._matcher_321)
    ...
    def _matcher_325(self, stream):
        return stream.with_scope(self._state, self._matcher_324)
    ...
    def _matcher_330(self, stream):
        return stream.operator_star(self._matcher_329)
    def _matcher_331(self, stream):
        return stream.bind('ys', self._matcher_330(stream))
    def _matcher_332(self, stream):
        return self._rules['hostExpr'](stream)
    def _matcher_333(self, stream):
        return stream.bind('x', self._matcher_332(stream))
    ...
    def _matcher_336(self, stream):
        return stream.with_scope(self._state, self._matcher_335)
    ...
    def _matcher_339(self, stream):
        return stream.bind('x', self._matcher_338(stream))
    ...
    def _matcher_344(self, stream):
        return stream.with_scope(self._state, self._matcher_343)
    def _matcher_345(self, stream):
        return stream.operator_or([
            self._matcher_344
        ])
    def _matcher_346(self, stream):
        return stream.operator_not(self._matcher_345)
    ...
    def _matcher_349(self, stream):
        return stream.with_scope(self._state, self._matcher_348)
    ...
    def _matcher_355(self, stream):
        return stream.operator_not(self._matcher_354)
    ...
    def _matcher_358(self, stream):
        return stream.with_scope(self._state, self._matcher_357)
    def _matcher_359(self, stream):
        return stream.operator_or([
            self._matcher_358
        ])
    def _matcher_360(self, stream):
        return stream.operator_star(self._matcher_359)
    def _matcher_361(self, stream):
        return stream.bind('xs', self._matcher_360(stream))
    ...
    def _matcher_366(self, stream):
        return stream.with_scope(self._state, self._matcher_365)
    ...
    def _matcher_372(self, stream):
        return stream.operator_not(self._matcher_371)
    def _matcher_373(self, stream):
        return self._rules['innerChar'](stream)
    def _matcher_374(self, stream):
        return stream.bind('x', self._matcher_373(stream))
    ...
    def _matcher_379(self, stream):
        return stream.with_scope(self._state, self._matcher_378)
    ...
    def _matcher_385(self, stream):
        return stream.with_scope(self._state, self._matcher_384)
    ...
    def _matcher_388(self, stream):
        return stream.with_scope(self._state, self._matcher_387)
    ...
    def _matcher_394(self, stream):
        return stream.with_scope(self._state, self._matcher_393)
    ...
    def _matcher_399(self, stream):
        return stream.with_scope(self._state, self._matcher_398)
    ...
    def _matcher_404(self, stream):
        return stream.with_scope(self._state, self._matcher_403)
    ...
    def _matcher_409(self, stream):
        return stream.with_scope(self._state, self._matcher_408)
    ...
    def _matcher_412(self, stream):
        return stream.bind('x', self._matcher_411(stream))
    def _matcher_413(self, stream):
        return stream.match(lambda item: '0' <= item <= '9', "'0'-'9'")
    def _matcher_414(self, stream):
        return stream.operator_star(self._matcher_413)
    def _matcher_415(self, stream):
        return stream.bind('xs', self._matcher_414(stream))
    ...
    def _matcher_418(self, stream):
        return stream.with_scope(self._state, self._matcher_417)
    ...
    def _matcher_422(self, stream):
        return stream.bind('x', self._matcher_421(stream))
    def _matcher_423(self, stream):
        return self._rules['nameChar'](stream)
    def _matcher_424(self, stream):
        return stream.operator_star(self._matcher_423)
    def _matcher_425(self, stream):
        return stream.bind('xs', self._matcher_424(stream))
    ...
    def _matcher_428(self, stream):
        return stream.with_scope(self._state, self._matcher_427)
    ...
    def _matcher_432(self, stream):
        return stream.with_scope(self._state, self._matcher_431)
    ...
    def _matcher_435(self, stream):
        return stream.with_scope(self._state, self._matcher_434)
    ...
    def _matcher_439(self, stream):
        return stream.with_scope(self._state, self._matcher_438)
    ...
    def _matcher_442(self, stream):
        return stream.with_scope(self._state, self._matcher_441)
    ...
    def _matcher_445(self, stream):
        return stream.with_scope(self._state, self._matcher_444)
    ...
    def _matcher_450(self, stream):
        return stream.with_scope(self._state, self._matcher_449)
    ...
    def _matcher_454(self, stream):
        return stream.with_scope(self._state, self._matcher_453)
    ...
    def _matcher_456(self, stream):
        return stream.operator_star(self._matcher_455)
    def _matcher_457(self, stream):
        return stream.operator_and([
            self._matcher_456
        ])
    def _matcher_458(self, stream):
        return stream.with_scope(self._state, self._matcher_457)
...
class CodeGenerator:
    def __init__(self, n=None):
        ...
        self._rules = {
            ...
            'State2': self._matcher_202,
            'Call': self._matcher_210,
            'Lookup': self._matcher_216,
            'astList': self._matcher_223,
            'matcher': self._matcher_227,
            'repr': self._matcher_233,
        }
    def run(self, stream):
        return self._rules['run'](stream)
    def _matcher_0(self, stream):
    ...
    def _matcher_18(self, stream):
        return stream.with_scope(self._state, self._matcher_17)
    def _matcher_19(self, stream):
        return stream.operator_or([
            self._matcher_18
        ])
    ...
    def _matcher_28(self, stream):
        return stream.with_scope(self._state, self._matcher_27)
    def _matcher_29(self, stream):
        return stream.operator_or([
            self._matcher_28
        ])
    ...
    def _matcher_37(self, stream):
        return stream.with_scope(self._state, self._matcher_36)
    def _matcher_38(self, stream):
        return stream.operator_or([
            self._matcher_37
        ])
    ...
    def _matcher_45(self, stream):
        return stream.with_scope(self._state, self._matcher_44)
    def _matcher_46(self, stream):
        return stream.operator_or([
            self._matcher_45
        ])
    ...
    def _matcher_53(self, stream):
        return stream.with_scope(self._state, self._matcher_52)
    def _matcher_54(self, stream):
        return stream.operator_or([
            self._matcher_53
        ])
    ...
    def _matcher_61(self, stream):
        return stream.with_scope(self._state, self._matcher_60)
    def _matcher_62(self, stream):
        return stream.operator_or([
            self._matcher_61
        ])
    ...
    def _matcher_69(self, stream):
        return stream.with_scope(self._state, self._matcher_68)
    def _matcher_70(self, stream):
        return stream.operator_or([
            self._matcher_69
        ])
    ...
    def _matcher_79(self, stream):
        return stream.with_scope(self._state, self._matcher_78)
    def _matcher_80(self, stream):
        return stream.operator_or([
            self._matcher_79
        ])
    ...
    def _matcher_87(self, stream):
        return stream.with_scope(self._state, self._matcher_86)
    def _matcher_88(self, stream):
        return stream.operator_or([
            self._matcher_87
        ])
    ...
    def _matcher_95(self, stream):
        return stream.with_scope(self._state, self._matcher_94)
    def _matcher_96(self, stream):
        return stream.operator_or([
            self._matcher_95
        ])
    ...
    def _matcher_101(self, stream):
        return stream.with_scope(self._state, self._matcher_100)
    def _matcher_102(self, stream):
        return stream.operator_or([
            self._matcher_101
        ])
    ...
    def _matcher_109(self, stream):
        return stream.with_scope(self._state, self._matcher_108)
    def _matcher_110(self, stream):
        return stream.operator_or([
            self._matcher_109
        ])
    ...
    def _matcher_117(self, stream):
        return stream.with_scope(self._state, self._matcher_116)
    def _matcher_118(self, stream):
        return stream.operator_or([
            self._matcher_117
        ])
    ...
    def _matcher_125(self, stream):
        return stream.with_scope(self._state, self._matcher_124)
    def _matcher_126(self, stream):
        return stream.operator_or([
            self._matcher_125
        ])
    ...
    def _matcher_133(self, stream):
        return stream.with_scope(self._state, self._matcher_132)
    def _matcher_134(self, stream):
        return stream.operator_or([
            self._matcher_133
        ])
    ...
    def _matcher_137(self, stream):
        return stream.with_scope(self._state, self._matcher_136)
    def _matcher_138(self, stream):
        return stream.operator_or([
            self._matcher_137
        ])
    ...
    def _matcher_143(self, stream):
        return stream.with_scope(self._state, self._matcher_142)
    def _matcher_144(self, stream):
        return stream.operator_or([
            self._matcher_143
        ])
    ...
    def _matcher_167(self, stream):
        return stream.with_scope(self._state, self._matcher_166)
    def _matcher_168(self, stream):
        return stream.operator_or([
            self._matcher_167
        ])
    ...
    def _matcher_171(self, stream):
        return stream.with_scope(self._state, self._matcher_170)
    def _matcher_172(self, stream):
        return stream.operator_or([
            self._matcher_171
        ])
    ...
    def _matcher_175(self, stream):
        return stream.with_scope(self._state, self._matcher_174)
    def _matcher_176(self, stream):
        return stream.operator_or([
            self._matcher_175
        ])
    ...
    def _matcher_201(self, stream):
        return stream.with_scope(self._state, self._matcher_200)
    def _matcher_202(self, stream):
        return stream.operator_or([
            self._matcher_201
        ])
    def _matcher_203(self, stream):
        return self._rules['ast'](stream)
    def _matcher_204(self, stream):
        return stream.bind('x', self._matcher_203(stream))
    def _matcher_205(self, stream):
        return self._rules['astList'](stream)
    def _matcher_206(self, stream):
        return stream.bind('y', self._matcher_205(stream))
    def _matcher_207(self, stream):
        return stream.action(lambda self: self.lookup('join')([
            self.lookup('x'),
            '(',
    ...
    def _matcher_209(self, stream):
        return stream.with_scope(self._state, self._matcher_208)
    def _matcher_210(self, stream):
        return stream.operator_or([
            self._matcher_209
        ])
    def _matcher_211(self, stream):
        return self._rules['repr'](stream)
    def _matcher_212(self, stream):
        return stream.bind('x', self._matcher_211(stream))
    def _matcher_213(self, stream):
        return stream.action(lambda self: self.lookup('join')([
            'self.lookup(',
            self.lookup('x'),
    ...
    def _matcher_215(self, stream):
        return stream.with_scope(self._state, self._matcher_214)
    def _matcher_216(self, stream):
        return stream.operator_or([
            self._matcher_215
        ])
    def _matcher_217(self, stream):
        return self._rules['ast'](stream)
    def _matcher_218(self, stream):
        return stream.operator_star(self._matcher_217)
    def _matcher_219(self, stream):
        return stream.bind('xs', self._matcher_218(stream))
    def _matcher_220(self, stream):
        return stream.action(lambda self: self.lookup('join')([
            '\n',
            self.lookup('indent')(
    ...
    def _matcher_222(self, stream):
        return stream.with_scope(self._state, self._matcher_221)
    def _matcher_223(self, stream):
        return stream.operator_or([
            self._matcher_222
        ])
    ...
    def _matcher_226(self, stream):
        return stream.with_scope(self._state, self._matcher_225)
    def _matcher_227(self, stream):
        return stream.operator_or([
            self._matcher_226
        ])
    def _matcher_228(self, stream):
        return stream.match(lambda item: True, 'any')
    def _matcher_229(self, stream):
        return stream.bind('x', self._matcher_228(stream))
    def _matcher_230(self, stream):
    ...
    def _matcher_232(self, stream):
        return stream.with_scope(self._state, self._matcher_231)
    def _matcher_233(self, stream):
        return stream.operator_or([
            self._matcher_232
        ])
