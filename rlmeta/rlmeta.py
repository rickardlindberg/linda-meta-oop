...
class Parser:
    def __init__(self):
        ...
        self._rules = {
            ...
            'body': self._matcher_53,
            'field': self._matcher_59,
            'rule': self._matcher_70,
            'choice': self._matcher_92,
            'sequence': self._matcher_104,
            'expr': self._matcher_126,
            'expr1': self._matcher_151,
            'expr2': self._matcher_160,
            'expr3': self._matcher_231,
            'matchChar': self._matcher_236,
            'maybeAction': self._matcher_244,
            'actionExpr': self._matcher_274,
            'hostExpr': self._matcher_323,
            'hostListItem': self._matcher_332,
            'var': self._matcher_342,
            'restLine': self._matcher_355,
            'indented': self._matcher_361,
            'string': self._matcher_375,
            'char': self._matcher_385,
            'innerChar': self._matcher_392,
            'escape': self._matcher_409,
            'number': self._matcher_417,
            'name': self._matcher_427,
            'reserved': self._matcher_432,
            'keyDef': self._matcher_439,
            'keyActor': self._matcher_448,
            'nameStart': self._matcher_453,
            'nameChar': self._matcher_460,
            'space': self._matcher_467,
        }
    def run(self, stream):
        return self._rules['run'](stream)
    def _matcher_0(self, stream):
    ...
    def _matcher_48(self, stream):
        return stream.operator_star(self._matcher_47)
    def _matcher_49(self, stream):
        return stream.bind('zs', self._matcher_48(stream))
    ...
    def _matcher_52(self, stream):
        return stream.with_scope(self._matcher_51)
    ...
    def _matcher_67(self, stream):
        return stream.bind('y', self._matcher_66(stream))
    ...
    def _matcher_77(self, stream):
        return stream.bind('x', self._matcher_76(stream))
    ...
    def _matcher_88(self, stream):
        return stream.operator_star(self._matcher_87)
    def _matcher_89(self, stream):
        return stream.bind('xs', self._matcher_88(stream))
    ...
    def _matcher_117(self, stream):
        return stream.operator_star(self._matcher_116)
    def _matcher_118(self, stream):
        return stream.bind('xs', self._matcher_117(stream))
    ...
    def _matcher_148(self, stream):
        return stream.with_scope(self._matcher_147)
    ...
    def _matcher_172(self, stream):
        return stream.bind('x', self._matcher_171(stream))
    ...
    def _matcher_190(self, stream):
        return stream.operator_not(self._matcher_189)
    ...
    def _matcher_195(self, stream):
        return stream.operator_star(self._matcher_194)
    def _matcher_196(self, stream):
        return stream.bind('xs', self._matcher_195(stream))
    ...
    def _matcher_250(self, stream):
        return stream.bind('x', self._matcher_249(stream))
    ...
    def _matcher_260(self, stream):
        return stream.bind('y', self._matcher_259(stream))
    ...
    def _matcher_264(self, stream):
        return stream.bind('z', self._matcher_263(stream))
    ...
    def _matcher_267(self, stream):
        return stream.with_scope(self._matcher_266)
    ...
    def _matcher_276(self, stream):
        return stream.bind('x', self._matcher_275(stream))
    ...
    def _matcher_281(self, stream):
        return stream.bind('x', self._matcher_280(stream))
    ...
    def _matcher_289(self, stream):
        return stream.operator_star(self._matcher_288)
    def _matcher_290(self, stream):
        return stream.bind('xs', self._matcher_289(stream))
    ...
    def _matcher_300(self, stream):
        return stream.operator_star(self._matcher_299)
    def _matcher_301(self, stream):
        return stream.bind('xs', self._matcher_300(stream))
    ...
    def _matcher_314(self, stream):
        return stream.operator_star(self._matcher_313)
    def _matcher_315(self, stream):
        return stream.bind('ys', self._matcher_314(stream))
    ...
    def _matcher_326(self, stream):
        return stream.operator_star(self._matcher_325)
    def _matcher_327(self, stream):
        return stream.bind('ys', self._matcher_326(stream))
    ...
    def _matcher_332(self, stream):
        return stream.with_scope(self._matcher_331)
    def _matcher_333(self, stream):
        return self._rules['name'](stream)
    def _matcher_334(self, stream):
        return stream.bind('x', self._matcher_333(stream))
    ...
    def _matcher_339(self, stream):
        return stream.operator_not(self._matcher_338)
    ...
    def _matcher_345(self, stream):
        return stream.operator_not(self._matcher_344)
    ...
    def _matcher_350(self, stream):
        return stream.operator_star(self._matcher_349)
    def _matcher_351(self, stream):
        return stream.bind('xs', self._matcher_350(stream))
    ...
    def _matcher_365(self, stream):
        return stream.operator_not(self._matcher_364)
    ...
    def _matcher_368(self, stream):
        return stream.with_scope(self._matcher_367)
    def _matcher_369(self, stream):
        return stream.operator_or([
            self._matcher_368
        ])
    def _matcher_370(self, stream):
        return stream.operator_star(self._matcher_369)
    def _matcher_371(self, stream):
        return stream.bind('xs', self._matcher_370(stream))
    ...
    def _matcher_379(self, stream):
        return stream.operator_not(self._matcher_378)
    def _matcher_380(self, stream):
        return self._rules['innerChar'](stream)
    def _matcher_381(self, stream):
        return stream.bind('x', self._matcher_380(stream))
    ...
    def _matcher_411(self, stream):
        return stream.bind('x', self._matcher_410(stream))
    ...
    def _matcher_414(self, stream):
        return stream.bind('xs', self._matcher_413(stream))
    ...
    def _matcher_419(self, stream):
        return stream.operator_not(self._matcher_418)
    ...
    def _matcher_423(self, stream):
        return stream.operator_star(self._matcher_422)
    def _matcher_424(self, stream):
        return stream.bind('xs', self._matcher_423(stream))
    ...
    def _matcher_437(self, stream):
        return stream.operator_not(self._matcher_436)
    ...
    def _matcher_446(self, stream):
        return stream.operator_not(self._matcher_445)
    ...
    def _matcher_452(self, stream):
        return stream.with_scope(self._matcher_451)
    ...
    def _matcher_466(self, stream):
        return stream.operator_star(self._matcher_465)
