...
class Parser:
    def __init__(self):
        ...
        self._rules = {
            ...
            'name': self._matcher_426,
            'nameStart': self._matcher_431,
            'nameChar': self._matcher_438,
            'space': self._matcher_445,
        }
    def run(self, stream):
        return self._rules['run'](stream)
    def _matcher_0(self, stream):
    ...
    def _matcher_420(self, stream):
        return stream.bind('x', self._matcher_419(stream))
    def _matcher_421(self, stream):
        return self._rules['nameChar'](stream)
    def _matcher_422(self, stream):
        return stream.operator_star(self._matcher_421)
    def _matcher_423(self, stream):
        return stream.bind('xs', self._matcher_422(stream))
    ...
    def _matcher_426(self, stream):
        return stream.with_scope(self._matcher_425)
    ...
    def _matcher_433(self, stream):
        return stream.with_scope(self._matcher_432)
    ...
    def _matcher_444(self, stream):
        return stream.operator_star(self._matcher_443)
    def _matcher_445(self, stream):
        return stream.with_scope(self._matcher_444)
class Optimizer:
    def __init__(self):
        self._state = {}
        self._rules = {
