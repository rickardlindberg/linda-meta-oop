...
class Parser:
    def __init__(self):
        ...
        self._rules = {
            ...
            'body': self._matcher_83,
            'examplesp': self._matcher_99,
            'example': self._matcher_112,
            'globalHostExpr': self._matcher_117,
            'whereItems': self._matcher_128,
            'field': self._matcher_134,
            'rule': self._matcher_145,
            'choice': self._matcher_167,
            'sequence': self._matcher_179,
            'expr': self._matcher_201,
            'expr1': self._matcher_226,
            'expr2': self._matcher_235,
            'expr3': self._matcher_306,
            'matchChar': self._matcher_311,
            'maybeAction': self._matcher_319,
            'actionExpr': self._matcher_349,
            'hostExpr': self._matcher_398,
            'hostListItem': self._matcher_407,
            'var': self._matcher_417,
            'restLine': self._matcher_430,
            'indented': self._matcher_436,
            'string': self._matcher_450,
            'char': self._matcher_460,
            'innerChar': self._matcher_467,
            'escape': self._matcher_484,
            'number': self._matcher_492,
            'name': self._matcher_502,
            'reserved': self._matcher_513,
            'keyDef': self._matcher_520,
            'keyActor': self._matcher_529,
            'keyWhere': self._matcher_538,
            'keyUniverse': self._matcher_550,
            'keyExamples': self._matcher_562,
            'nameStart': self._matcher_567,
            'nameChar': self._matcher_574,
            'space': self._matcher_581,
        }
        self._main = self._rules.pop('_main')
    def run(self, stream):
        return self._main(stream)
    ...
    def _matcher_53(self, stream):
        return stream.bind('ys', self._matcher_52(stream))
    ...
    def _matcher_59(self, stream):
        return stream.operator_star(self._matcher_58)
    def _matcher_60(self, stream):
        return stream.bind('zs', self._matcher_59(stream))
    ...
    def _matcher_79(self, stream):
        return stream.bind('ys', self._matcher_78(stream))
    ...
    def _matcher_88(self, stream):
        return stream.bind('x', self._matcher_87(stream))
    ...
    def _matcher_92(self, stream):
        return stream.operator_star(self._matcher_91)
    def _matcher_93(self, stream):
        return stream.bind('xs', self._matcher_92(stream))
    ...
    def _matcher_96(self, stream):
        return stream.with_scope(self._matcher_95)
    ...
    def _matcher_109(self, stream):
        return stream.bind('y', self._matcher_108(stream))
    ...
    def _matcher_112(self, stream):
        return stream.with_scope(self._matcher_111)
    ...
    def _matcher_123(self, stream):
        return stream.operator_star(self._matcher_122)
    ...
    def _matcher_142(self, stream):
        return stream.bind('y', self._matcher_141(stream))
    ...
    def _matcher_161(self, stream):
        return stream.with_scope(self._matcher_160)
    def _matcher_162(self, stream):
        return stream.operator_or([
            self._matcher_161
        ])
    def _matcher_163(self, stream):
        return stream.operator_star(self._matcher_162)
    def _matcher_164(self, stream):
        return stream.bind('xs', self._matcher_163(stream))
    ...
    def _matcher_171(self, stream):
        return stream.operator_star(self._matcher_170)
    def _matcher_172(self, stream):
        return stream.bind('xs', self._matcher_171(stream))
    ...
    def _matcher_176(self, stream):
        return stream.bind('ys', self._matcher_175(stream))
    ...
    def _matcher_184(self, stream):
        return stream.bind('y', self._matcher_183(stream))
    ...
    def _matcher_187(self, stream):
        return stream.with_scope(self._matcher_186)
    ...
    def _matcher_192(self, stream):
        return stream.operator_star(self._matcher_191)
    def _matcher_193(self, stream):
        return stream.bind('xs', self._matcher_192(stream))
    ...
    def _matcher_198(self, stream):
        return stream.with_scope(self._matcher_197)
    def _matcher_199(self, stream):
        return self._rules['expr1'](stream)
    def _matcher_200(self, stream):
        return stream.with_scope(self._matcher_199)
    ...
    def _matcher_203(self, stream):
        return stream.bind('x', self._matcher_202(stream))
    ...
    def _matcher_207(self, stream):
        return stream.with_scope(self._matcher_206)
    ...
    def _matcher_225(self, stream):
        return stream.with_scope(self._matcher_224)
    ...
    def _matcher_232(self, stream):
        return stream.with_scope(self._matcher_231)
    ...
    def _matcher_237(self, stream):
        return stream.bind('x', self._matcher_236(stream))
    ...
    def _matcher_242(self, stream):
        return stream.operator_not(self._matcher_241)
    ...
    def _matcher_247(self, stream):
        return stream.bind('x', self._matcher_246(stream))
    def _matcher_248(self, stream):
        return stream.match(lambda item: item == '-', "'-'")
    def _matcher_249(self, stream):
        return self._rules['char'](stream)
    def _matcher_250(self, stream):
        return stream.bind('y', self._matcher_249(stream))
    ...
    def _matcher_261(self, stream):
        return stream.with_scope(self._matcher_260)
    ...
    def _matcher_265(self, stream):
        return stream.operator_not(self._matcher_264)
    ...
    def _matcher_268(self, stream):
        return stream.with_scope(self._matcher_267)
    def _matcher_269(self, stream):
        return stream.operator_or([
            self._matcher_268
        ])
    def _matcher_270(self, stream):
        return stream.operator_star(self._matcher_269)
    def _matcher_271(self, stream):
        return stream.bind('xs', self._matcher_270(stream))
    ...
    def _matcher_275(self, stream):
        return stream.with_scope(self._matcher_274)
    ...
    def _matcher_284(self, stream):
        return stream.bind('x', self._matcher_283(stream))
    ...
    def _matcher_289(self, stream):
        return stream.with_scope(self._matcher_288)
    ...
    def _matcher_305(self, stream):
        return stream.with_scope(self._matcher_304)
    ...
    def _matcher_308(self, stream):
        return stream.bind('x', self._matcher_307(stream))
    ...
    def _matcher_316(self, stream):
        return stream.with_scope(self._matcher_315)
    def _matcher_317(self, stream):
        return stream.action(lambda self: self.lookup('concat')([
        
        ]))
    def _matcher_318(self, stream):
        return stream.with_scope(self._matcher_317)
    ...
    def _matcher_330(self, stream):
        return stream.with_scope(self._matcher_329)
    ...
    def _matcher_333(self, stream):
        return stream.with_scope(self._matcher_332)
    ...
    def _matcher_335(self, stream):
        return stream.bind('y', self._matcher_334(stream))
    ...
    def _matcher_339(self, stream):
        return stream.bind('z', self._matcher_338(stream))
    ...
    def _matcher_342(self, stream):
        return stream.with_scope(self._matcher_341)
    ...
    def _matcher_351(self, stream):
        return stream.bind('x', self._matcher_350(stream))
    ...
    def _matcher_354(self, stream):
        return stream.with_scope(self._matcher_353)
    def _matcher_355(self, stream):
        return self._rules['number'](stream)
    def _matcher_356(self, stream):
        return stream.bind('x', self._matcher_355(stream))
    ...
    def _matcher_364(self, stream):
        return stream.operator_star(self._matcher_363)
    def _matcher_365(self, stream):
        return stream.bind('xs', self._matcher_364(stream))
    ...
    def _matcher_375(self, stream):
        return stream.operator_star(self._matcher_374)
    def _matcher_376(self, stream):
        return stream.bind('xs', self._matcher_375(stream))
    ...
    def _matcher_381(self, stream):
        return stream.with_scope(self._matcher_380)
    def _matcher_382(self, stream):
        return self._rules['var'](stream)
    def _matcher_383(self, stream):
        return stream.bind('x', self._matcher_382(stream))
    ...
    def _matcher_389(self, stream):
        return stream.operator_star(self._matcher_388)
    def _matcher_390(self, stream):
        return stream.bind('ys', self._matcher_389(stream))
    ...
    def _matcher_397(self, stream):
        return stream.with_scope(self._matcher_396)
    ...
    def _matcher_401(self, stream):
        return stream.operator_star(self._matcher_400)
    def _matcher_402(self, stream):
        return stream.bind('ys', self._matcher_401(stream))
    ...
    def _matcher_409(self, stream):
        return stream.bind('x', self._matcher_408(stream))
    ...
    def _matcher_414(self, stream):
        return stream.operator_not(self._matcher_413)
    ...
    def _matcher_417(self, stream):
        return stream.with_scope(self._matcher_416)
    ...
    def _matcher_420(self, stream):
        return stream.operator_not(self._matcher_419)
    ...
    def _matcher_425(self, stream):
        return stream.operator_star(self._matcher_424)
    def _matcher_426(self, stream):
        return stream.bind('xs', self._matcher_425(stream))
    ...
    def _matcher_436(self, stream):
        return stream.with_scope(self._matcher_435)
    ...
    def _matcher_440(self, stream):
        return stream.operator_not(self._matcher_439)
    ...
    def _matcher_443(self, stream):
        return stream.with_scope(self._matcher_442)
    def _matcher_444(self, stream):
        return stream.operator_or([
            self._matcher_443
        ])
    def _matcher_445(self, stream):
        return stream.operator_star(self._matcher_444)
    def _matcher_446(self, stream):
        return stream.bind('xs', self._matcher_445(stream))
    ...
    def _matcher_456(self, stream):
        return stream.bind('x', self._matcher_455(stream))
    ...
    def _matcher_460(self, stream):
        return stream.with_scope(self._matcher_459)
    ...
    def _matcher_464(self, stream):
        return stream.with_scope(self._matcher_463)
    def _matcher_465(self, stream):
        return stream.match(lambda item: True, 'any')
    def _matcher_466(self, stream):
        return stream.with_scope(self._matcher_465)
    ...
    def _matcher_471(self, stream):
        return stream.with_scope(self._matcher_470)
    ...
    def _matcher_475(self, stream):
        return stream.with_scope(self._matcher_474)
    ...
    def _matcher_479(self, stream):
        return stream.with_scope(self._matcher_478)
    ...
    def _matcher_486(self, stream):
        return stream.bind('x', self._matcher_485(stream))
    def _matcher_487(self, stream):
        return stream.match(lambda item: '0' <= item <= '9', "'0'-'9'")
    def _matcher_488(self, stream):
        return stream.operator_star(self._matcher_487)
    def _matcher_489(self, stream):
        return stream.bind('xs', self._matcher_488(stream))
    ...
    def _matcher_502(self, stream):
        return stream.with_scope(self._matcher_501)
    ...
    def _matcher_506(self, stream):
        return stream.with_scope(self._matcher_505)
    def _matcher_507(self, stream):
        return self._rules['keyWhere'](stream)
    def _matcher_508(self, stream):
        return stream.with_scope(self._matcher_507)
    def _matcher_509(self, stream):
        return self._rules['keyUniverse'](stream)
    def _matcher_510(self, stream):
        return stream.with_scope(self._matcher_509)
    def _matcher_511(self, stream):
        return self._rules['keyExamples'](stream)
    def _matcher_512(self, stream):
        return stream.with_scope(self._matcher_511)
    ...
    def _matcher_518(self, stream):
        return stream.operator_not(self._matcher_517)
    ...
    def _matcher_527(self, stream):
        return stream.operator_not(self._matcher_526)
    ...
    def _matcher_529(self, stream):
        return stream.with_scope(self._matcher_528)
    ...
    def _matcher_536(self, stream):
        return stream.operator_not(self._matcher_535)
    ...
    def _matcher_538(self, stream):
        return stream.with_scope(self._matcher_537)
    ...
    def _matcher_564(self, stream):
        return stream.with_scope(self._matcher_563)
    def _matcher_565(self, stream):
        return stream.match(lambda item: 'A' <= item <= 'Z', "'A'-'Z'")
    def _matcher_566(self, stream):
        return stream.with_scope(self._matcher_565)
    ...
    def _matcher_569(self, stream):
        return stream.with_scope(self._matcher_568)
    def _matcher_570(self, stream):
        return stream.match(lambda item: 'A' <= item <= 'Z', "'A'-'Z'")
    def _matcher_571(self, stream):
        return stream.with_scope(self._matcher_570)
    def _matcher_572(self, stream):
        return stream.match(lambda item: '0' <= item <= '9', "'0'-'9'")
    def _matcher_573(self, stream):
        return stream.with_scope(self._matcher_572)
    ...
    def _matcher_580(self, stream):
        return stream.operator_star(self._matcher_579)
...
class CodeGenerator:
    def __init__(self):
        ...
        self._rules = {
            ...
            'Lookup': self._matcher_221,
            'astList': self._matcher_227,
            'matcher': self._matcher_229,
            'repr': self._matcher_234,
        }
        self._main = self._rules.pop('_main')
    def run(self, stream):
        return self._main(stream)
    ...
    def _matcher_45(self, stream):
        ...
        ), lambda: self.bind('universeName', self.lookup('x'), lambda: self.lookup('join')([
            self.lookup('ys'),
            'natives[',
            self.lookup('repr')(
                self.lookup('universeName')
            ),
            '] = lambda: [',
            self.lookup('xs'),
            ']\n'
    ...
    def _matcher_222(self, stream):
        return self._rules['ast'](stream)
    def _matcher_223(self, stream):
        return stream.operator_star(self._matcher_222)
    def _matcher_224(self, stream):
        return stream.bind('xs', self._matcher_223(stream))
    def _matcher_225(self, stream):
        return stream.action(lambda self: self.lookup('join')([
            '\n',
            self.lookup('indent')(
